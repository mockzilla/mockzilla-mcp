...
export const LOCAL_TOOLS = {
  ...
  mock_endpoint: {
    description:
      ...
      "Every mocked endpoint answers 200 with the body: the static " +
      "format has no slot for a status code. To make a client see a " +
      "failure, use `serve_locally` with `errors`. For a specific " +
      "status AND body, write an OpenAPI spec and serve that.\n\n" +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        status: {
          ...
          default: 200,
          description:
            "Always 200. A static endpoint cannot carry another status; " +
            "passing one is an error that explains the alternatives.",
        },
        content_type: {
          type: "string",
          description:
