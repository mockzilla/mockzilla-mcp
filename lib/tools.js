...
export const LOCAL_TOOLS = {
  ...
  login: {
    description:
      ...
      "right away with the login `url`; hosted tools appear once the user " +
      "approves. Call it when a hosted tool says it needs a login, or when " +
      "the user wants to deploy or manage hosted mocks. Local tools never " +
      "need it. Side effects: starts a short-lived listener on 127.0.0.1 " +
